...
#
# Pimp Out Yosemite
# Run ./set-defaults-yosemite.sh and you'll be good to go.
#
# Based on this:
#
...
if [ "${CURRENT_PROFILE}" != "${TERM_PROFILE}" ]; then
	open "${DOTFILES}/terminal/${TERM_PROFILE}.terminal";
...
# open "${DOTFILES}/iterm/${TERM_PROFILE}.itermcolors"
...
# NOT IN USE AS SYNCING VIA DOTFILES SETUP SCRIPT
